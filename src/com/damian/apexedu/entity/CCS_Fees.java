...
public class CCS_Fees implements SuperEntity {
    private String date;
    ...
    public CCS_Fees(String date, String student_id, String student_name, String payment_description, double amount) {
        this.date = date;
