...
public class Lecturer_Details implements SuperEntity {
    ...
    public Lecturer_Details(String lecturer_id, String program_id, String lecturer_name, String lecturer_address, String lecturer_email, int lecturer_telephone, double basic_salary) {
